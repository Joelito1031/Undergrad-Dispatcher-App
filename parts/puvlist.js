...
const PUVlist = ({navigation, ws}) => {
  ...
  const retrieveList = async() => {
    try{
      const response = await fetch('http://192.168.254.105/BeautifulPeople/processes/retrievelist.php', {
        method: 'POST',
        headers: {
  ...
  const unqueue = async(data) => {
    try{
      const response = await fetch('http://192.168.254.105/BeautifulPeople/processes/dispatcher_unqueue_vehicle.php', {
        method: 'POST',
        headers: {
          Accept: 'application/json',
          'Content-Type': 'application/json'
  ...
  const getProfile = async(filename, vehicle, capacity, passengers) => {
    try{
      const response = await fetch('http://192.168.254.105/BeautifulPeople/processes/dispatcher_get_vehicle_profile.php', {
        method: 'POST',
        headers: {
          Accept: 'application/json',
          'Content-Type': 'application/json'
